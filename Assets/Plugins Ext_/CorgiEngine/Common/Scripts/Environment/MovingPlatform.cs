...
{	
	...
	public class MovingPlatform : PathMovement, Respawnable 
	{
        ...
        private bool haveCollideWithPlayer = false;
			...
			get 
			{
				...
				if (OnlyMovesWhenPlayerIsColliding)
				{
                    ...
                    */
					...
					if (_collidingWithPlayer && _collidingController.ColliderBottomPosition.y < _platformTopY - _toleranceY)
					{
						return false;
					}
				}
