...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            if (GameObject.Find("SuperVariant") != null)
            {
                /*SuperVariant PostProfile = GameObject.Find("SuperVariant").GetComponent<SuperVariant>();
                Debug.Log(PostProfile.superVariant.ToString());
                if (PostProfile.superVariant.ToString() == "SuperMuscles")
                {
                    profile = PostProfile.superMusclesProfile;
                }
                else if (PostProfile.superVariant.ToString() == "Beer")
                {
                    profile = PostProfile.beerProfile;
                }
                else if (PostProfile.superVariant.ToString() =="Colorblind")
                {
                    profile = PostProfile.colorblindProfile;
                }
                else if (PostProfile.superVariant.ToString() == "Cannabis")
                {
                    profile = PostProfile.cannabisProfile;
                }
                else if (PostProfile.superVariant.ToString() == "Deafness")
                {
                    profile = PostProfile.deafnessProfile;
                }*/
